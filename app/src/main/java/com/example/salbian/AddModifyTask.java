...
public class AddModifyTask extends AppCompatActivity {
    ...
    public void init_modify() {
        ...
        if (task != null) {
            ...
            @SuppressLint("SimpleDateFormat") SimpleDateFormat iso8601Format = new SimpleDateFormat("yyyy-MM-dd");
            try {
    ...
    public void chooseDate(View view) {
        final View dialogView = View.inflate(this, R.layout.data_picker, null);
